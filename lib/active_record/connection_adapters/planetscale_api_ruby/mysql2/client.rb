# Keep `PlanetscaleApiRuby::Client` abstract and mix these methods
# in specifically to mimic the Mysql2 gem's interfaces.
#
module ActiveRecord
  module ConnectionAdapters
    module PlanetscaleApiRuby
      module Mysql2
        module Client
          ...
          def query(sql)
            ...
            PlanetscaleApiRuby::Mysql2::Result.new(result)
          end
      ...
      PlanetscaleApiRuby::Client.include PlanetscaleApiRuby::Mysql2::Client
    end
  end
end
